...
const OAUTH_AUTH_SCHEMA: ConnectorAuthSchema = {
  schema: z.object({
...
export const PLAID_AUTH_SCHEMA = OAUTH_AUTH_SCHEMA
export const QUICKBOOKS_AUTH_SCHEMA = OAUTH_AUTH_SCHEMA
export const XERO_AUTH_SCHEMA = OAUTH_AUTH_SCHEMA
...
export function authSchemaFor(connectorId: string): ConnectorAuthSchema | null {
  switch (connectorId) {
    ...
    case 'stripe': return STRIPE_AUTH_SCHEMA
    case 'plaid': return PLAID_AUTH_SCHEMA
    case 'quickbooks': return QUICKBOOKS_AUTH_SCHEMA
    case 'xero': return XERO_AUTH_SCHEMA
    default: return null
  }
}
